...
typedef enum TER_Notifier
{
  ...
  //TER_Notifier_HeaterOverCurrent           = 0x08000,
  //TER_Notifier_SledAlignment               = 0x00400,
  ...
  TER_Notifier_TempEnvelopeFault           = 0x20000,
  TER_Notifier_TempRampNotCompleted        = 0x40000,

  TER_Notifier_LatchedSledUnderTemp        = 0x80,
  TER_Notifier_LatchedSledOverTemp         = 0x400,
  TER_Notifier_LatchedSlotPcbOverTemp      = 0x4
...
//
 ...
 TER_Status TER_GetCmd9PollArray ( CMD9_STATUS *resp );
  ...
  //
  // TER_EnableMarshal ( bool enable )
  //
  //   enable/disable the on-the-wire Marshal.py protocol for XTER_ commands only
  //
