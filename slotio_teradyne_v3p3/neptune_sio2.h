...
#define DP_FLAGS_invalid_dio_tpn		 32
...
//////////////////////////////////////////////////////////////////////////
			    ...
			    // cal> where used ???
#define TER_MAX_ERROR_STRING_LENGTH      2048
			    // cal> where used ???
...
enum TER_DebugType
{
    ...
    TER_DebugType_EventOffAll		= 0x2, // disable Events on all channels
    TER_DebugType_EventOnAll		= 0x3, // enable Events on all channels
    TER_DebugType_EventOff		= 0x4, // disable Events on current channel
    TER_DebugType_EventOn		= 0x5, // enable Events on current channel
    TER_DebugType_AsyncOff              = 0x6, // Disable all async behavior.  Events , Waterfall
    TER_DebugType_AsyncOn               = 0x7, // Disable all async behavior.  Events , Waterfall
};

enum TER_MeasureType
{
    TER_MeasureType_None		= 0x00, // Take no action
    TER_MeasureType_Heater		= 0x01, // Take no action

};

// Seagate requires this to be only 16 bits.
typedef enum TER_Notifier
{
    TER_Notifier_Cleared		= 0x0000,
    TER_Notifier_SledHeaterFaultShort   = 0x0001,
    TER_Notifier_SledHeaterFaultOpen    = 0x0002,
    TER_Notifier_BlowerFault            = 0x0004,
    TER_Notifier_SlotCircuitOverTemp	= 0x0008,

    TER_Notifier_DriveRemoved           = 0x0010,
    TER_Notifier_DriveOverCurrent       = 0x0040,
    //  TER_Notifier_SledRemoved          	   = 0x00080,  //TODO: Implement!

    TER_Notifier_SlotCircuitFault	= 0x0100,
    TER_Notifier_LatchedSledOverTemp    = 0x0400,
    TER_Notifier_LatchedSledUnderTemp   = 0x0800,

    TER_Notifier_SledOverTemp		= 0x1000,
    TER_Notifier_SledTemperatureFault   = 0x2000,

    // The following will not be visible to Seagate:
    TER_Notifier_SledDiodeFault         = 0x10000,
    ...
    // Seagate requires this to be only 16 bits.
    TER_Notifier_SeagateMsk		= 0x0000ffff,
...
#define MARTER_TCP_COMMAND_Measure	        1025

// Private Teradyne commands:
#define MARTER_TCP_COMMAND_DioCmd               0x01000000
// not in spec and not implemented:
#define MARTER_TCP_COMMAND_WriteFpgaRegister    0x01000001
#define MARTER_TCP_COMMAND_ReadFpgaRegister     0x01000002
...
#define TER_Status_no_client_connection        2
#define TER_Status_slotid_error           3
#define TER_Status_InvalidMode            4
#define TER_Status_Error_Argument_Invalid 5
#define TER_Status_receive_packet_len_err 6	// TODO: Is this obsolete?
//#define TER_Status_invalid_reset_type     7
//#define TER_Status_data_length_error      8
#define TER_Status_linux_error            9     // TODO: delete.  THIS IS RETURNED only b NEPTUNE_SIO2!!!
...
#define TER_Status_UpgradeInfoMissing   34
...
#define TER_Status_DIO_STATUS_slotid_out_of_range     TER_Status_slotid_error
...
#define TER_Status_HTemp_Sled_Temperature_Fault 51
#define TER_Status_HTemp_Max_Adjustment_Reached 52
#define TER_Status_HTemp_Min_Adjustment_Reached 53

// bad case in super_state
//#define TER_Status_invalid_super_state_case 51
#define TER_STATUS_MAX 54
...
class Neptune_sio2
{
 private:
  ...
  /* Marshal.py */
    ...
    targetTemperature initialTargetTempForHTemp;
...
//#define SMALL_STAMPER
  ...
  //
  TER_Status TER_SetHitachiTemp(int slotid, unsigned short wTempInHundredth);
