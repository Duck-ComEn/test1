...
# parameters to wapitest t09 slot, tgt1, tgt2, stemp, ramp, testTime -deb7-L3 -q
extendedTest06()
{
	promptSlotNumber
	initTest
	...
	for((i=$startSlot; i<$endSlot+1; ++i));do
		...
		if [ $rem -eq 0 ]
		then
           ./wapitest t09 $i 6000 3000 2800 600 3600 -deb7 -L3 -q &
		else
           ./wapitest t09 $i 3000 6000 2800 600 3600 -deb7 -L3 -q &
		fi
	done
...
echo "6) htemp test on multiple slots"
